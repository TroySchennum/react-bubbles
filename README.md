...
A token is used for security and to authorize users to visit a page.

- [ ] What steps can you take in your web apps to keep your data secure?

Using authentication and tokens for login. 

- [ ] Describe how web servers work.

Web servers store, process and deliver web pages to clients. It will map virtual paths on to the real one.
